...
if (exists('&t_Co') && !empty(&t_Co) && &t_Co > 1 ? &t_Co : 2) < 256
  ...
  highlight NormalFloat cterm=NONE ctermfg=NONE ctermbg=0 gui=NONE guifg=NONE guibg=#444444
  ...
  highlight NonText cterm=italic ctermfg=3 ctermbg=NONE gui=italic guifg=#af8787 guibg=NONE
  highlight Folded cterm=italic ctermfg=3 ctermbg=0 gui=italic guifg=#af8787 guibg=#1c1c1c
  ...
  highlight ErrorMsg cterm=bold,reverse ctermfg=9 ctermbg=0 gui=bold,reverse guifg=#d787af guibg=#000000
  highlight WarningMsg cterm=bold,reverse ctermfg=11 ctermbg=0 gui=bold,reverse guifg=#d7af87 guibg=#000000
...
highlight NormalFloat cterm=NONE ctermfg=NONE ctermbg=238 gui=NONE guifg=NONE guibg=#444444
...
highlight NonText cterm=italic ctermfg=138 ctermbg=NONE gui=italic guifg=#af8787 guibg=NONE
highlight Folded cterm=italic ctermfg=138 ctermbg=234 gui=italic guifg=#af8787 guibg=#1c1c1c
...
highlight ErrorMsg cterm=bold,reverse ctermfg=175 ctermbg=16 gui=bold,reverse guifg=#d787af guibg=#000000
highlight WarningMsg cterm=bold,reverse ctermfg=180 ctermbg=16 gui=bold,reverse guifg=#d7af87 guibg=#000000
